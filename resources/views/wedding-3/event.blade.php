                ...
                <ul class="features_list_detailed">                   
                    <li>
                        ...
                        <div id="akad" class="feat_small_details">
                            ...
                            <a href="#">
                                <i class="fa fa-calendar"></i> &nbsp; Minggu, 8 April 2018<br>
                                <i class="fa fa-clock-o"></i>  &nbsp; Jam 08.00 s/d 10.00 WIB <br>
                                <i class="fa fa-map-marker"></i>   &nbsp;  &nbsp; Gedung SDELOG POLRI <br>
                                    &nbsp;  &nbsp;  &nbsp;  &nbsp; Jl. Bekasi Timur Raya No. 86 Cipinang, </br>           Jakarta Timur                           
                            </a>
                        </div>
                    </li>
                    <li>
                        ...
                        <div id="akad" class="feat_small_details">
                            <h4>
                                <a href="#"><strong>RESEPSI PERNIKAHAN</strong></a>
                            </h4>
                                <a href="#">
                                <i class="fa fa-calendar"></i>   &nbsp; Minggu, 8 April 2018<br>
                                <i class="fa fa-clock-o"></i>  &nbsp; Jam 11.00 s/d 13.00 WIB <br>
                                <i class="fa fa-map-marker"></i>   &nbsp;  &nbsp; Gedung SDELOG POLRI <br>
                                    &nbsp;  &nbsp;  &nbsp;  &nbsp;Jl. Bekasi Timur Raya No. 86 Cipinang, </br>           Jakarta Timur            </a>
                        </div>
                    </li>        
                </ul>
