<div data-page="team" class="page no-toolbar no-navbar hidden" id="couple">
    <div class="page-content">
        <div id="pages_maincontent">
            ...
            <div id="couple_content" class="page_single layout_fullwidth_padding"> <span> <strong id="pre_greeting"> Bismillahirrahmanirrahim</strong> <br> <strong> Assalamu`alaikum Warahmatullahi Wabarakatuh </strong> <br> Dengan memohon rahmat serta ridho Allah Subhanahu Wa Ta`ala kami bermaksud menyelenggarakan acara pernikahan putra putri kami </span>
                <div class="swiper-container-team swiper-init" data-effect="slide" data-space-between="0" data-pagination=".swiper-pagination-teambigger" data-slides-per-view="1">
                    <div class="swiper-wrapper">
                        <div id="brides" class="swiper-slide team-block"> <img src="{{ asset('images/couples/wanita/6.jpg') }}" alt="" title="" /> <strong> Senja Putri Alfiah </strong> Putri Pertama dari Bpk. Muhammad Maulana & Ibu Natasha Alfiah</div>
                    </div>
                </div> <span id="dengan"> <strong>dengan</strong> <br> </span>
                <div class="swiper-container-team swiper-init" data-effect="slide" data-space-between="0" data-pagination=".swiper-pagination-teambigger" data-slides-per-view="1">
                    <div class="swiper-wrapper">
                        <div id="brides" class="swiper-slide team-block"> <img src="{{ asset('images/couples/pria/6.jpg') }}" alt="" title="" /> <strong>Fajar Putra Maulana</strong> Putra Pertama dari Bpk. Ferdiansyah & Ibu Tari Ananda</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="swiper-container-team swiper-init" data-effect="slide" data-space-between="0" data-pagination=".swiper-pagination-teambigger" data-slides-per-view="1">
                        <div class="swiper-wrapper">
                            <div id="brides" class="swiper-slide team-block">
                                ...
                                <strong>
						  		Senja Putri Alfiah
						  	</strong> Putri Pertama dari Bpk. Muhammad Maulana & Ibu Natasha Alfiah
                            </div>
                        </div>
                    </div>
                    <span id="dengan">
                    ...
                    <div class="swiper-container-team swiper-init" data-effect="slide" data-space-between="0" data-pagination=".swiper-pagination-teambigger" data-slides-per-view="1">
                        <div class="swiper-wrapper">
                            <div id="brides" class="swiper-slide team-block">
                                ...
                                <strong>Fajar Putra Maulana</strong> Putra Pertama dari Bpk. Ferdiansyah & Ibu Tari Ananda
                            </div>
                        </div>
                    </div>
                </div>
