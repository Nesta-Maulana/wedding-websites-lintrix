...
function init() {
    ...
    var description = '<div id="iw-container">' +
        '<div class="iw-title">Assembly Hall 10th Floor, Menara Mandiri</div>' +
        '<div class="iw-content">' +
        '<br/>' + 
        '<p class="iw-desc iw-address">Jl. Jend. Sudirman No.Kav 54-55, RT.5/RW.3, Senayan, Kby. Baru, Kota Jakarta Selatan, Jakarta.</p>' +
        '<p class="iw-direct"><a href="https://maps.google.com?daddr=Assembly+Hall+Menara+Mandiri,+Jl.+Jend.+Sudirman+No.Kav+54-55&z=18" target="_blank" class="iw-link">Get Direction</a>'+
        '</div>' +
        '</div>';
