                ...
                <ul class="features_list_detailed">
                    <li>
                        <div class="feat_small_icon">
                            <img src="{{ asset('wedding-1/images/icons/gold/wedding-ring.png') }}" alt="" title="" />
                        </div>
                        <div id="akad" class="feat_small_details">
                            <h4>
                                <a href="javascript:void(0)" >AKAD NIKAH</a>
                            </h4>
                    ...
                    <li>
                        <div class="feat_small_icon">
                            <img src="{{ asset('wedding-1/images/icons/gold/dove.png') }}" alt="" title="" />
                        </div>
                        <div id="akad" class="feat_small_details">
                            <h4>
                                <a href="javascript:void(0)"><strong>RESEPSI PERNIKAHAN</strong></a>
                            </h4>
                            <a href="javascript:void(0)">
                                <i class="fa fa-calendar"></i>   &nbsp; Sabtu, 27 Desember 2018<br>
