...
<head>
    ...
    <meta property="og:image" content="{{ asset('wedding-6/images/imagelink/1.jpg')}}"> 
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('wedding-6/css/customs.css') }}" />    
                    ...
                    <div class="page-content">
                        <nav class="main-nav icons_21">
                            <ul >  
                                ...
                                <li>
                                    <a href="" onclick="pindahMenu('video')" class="close-panel" data-view=".view-main">
                                        <img src="{{ asset('images/icons/gold/message.png') }}" alt="" title="" />
